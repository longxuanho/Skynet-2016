...
//==================================
// Schemas only: THONGSOKYTHUATCHUNG

Schemas.ThongSoKyThuatChungSchema = new SimpleSchema({
    loai_thong_so: {
        type: Object,
        label: "Loại Thông Số",
        optional: true
    ...
    'loai_thong_so.ma': {
        type: String,
        label: "Mã Loại Thông Số",
        optional: true
    },
    'loai_thong_so.mo_ta': {
        type: String,
        label: "Loại Thông Số - Mô tả",
        optional: true
    },
    'loai_thong_so.icon': {
        type: String,
        label: "Loại Thông Số - Icon",
        optional: true
    },
    don_vi: {
        type: String,
...
Schemas.ThietBiSchema = new SimpleSchema({
    ...
    thong_so_ky_thuat: {
        type: [Schemas.ThongSoKyThuatChungSchema],
    ...
    status: {
        type: String,
        optional: false,
        allowedValues: ['active', 'idle', 'liquidate'],
        defaultValue: 'active',
        label: "Trạng thái"
    }
});
...
Schemas.UserSettingSchema = new SimpleSchema({
    ...
    phan_loai: {
        type: String,
        allowedValues: ['uigrid_state', 'thietbis_template', 'kendo_grid', 'kendo_grid_thietbis'],
        label: "Phân Loại"
    },
    user: {
        type: Object
...
Schemas.NhanSuSchema = new SimpleSchema({
    ...
    cong_viec: {
        ...
        'cong_viec.to_chuc_bien_che': {  
            ...
            'cong_viec.to_chuc_bien_che.phan_loai_bien_che': {  // etc. LĐHĐ, LĐQP
                type: String,
                optional: true
            },
            'cong_viec.to_chuc_bien_che.phan_loai_to_chuc': { // etc. Phòng Ban, Tổ Đội, Ban Giám Đốc
                type: String,
                optional: true
            },
        ...
        'cong_viec.trang_thai': {
            type: String,
            allowedValues: ['dang_lam_viec', 'nghi_huu', 'nghi_phep']
        },
        'cong_viec.ho_so': {
            type: Object,
            optional: true
    ...
    thong_tin_lien_lac: {
        ...
        'thong_tin_lien_lac.so_dien_thoai': {
            type: [String],
            optional: true
        },
        'thong_tin_lien_lac.nguoi_bao_tin': {
            type: Object,
            optional: true,
            blackbox: true
        },
        'thong_tin_lien_lac.nguoi_bao_lanh': {
            type: Object,
            optional: true,
            blackbox: true
        },
