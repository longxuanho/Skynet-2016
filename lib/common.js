...
Schemas.CauHoiSchema = new SimpleSchema({
    ...
    phan_loai: {
        ...
        'phan_loai.nhom_cau_hoi': {
            ...
            'phan_loai.nhom_cau_hoi.tieu_de': {
                type: String
            },
        ...
        'phan_loai.nhom_noi_dung': {
            type: Object
        },
            'phan_loai.nhom_noi_dung.ten': {
                type: String
            },
            'phan_loai.nhom_noi_dung.ma': {
                type: String
            },
        'phan_loai.bac_thi': {
            type: [String],
    ...
    noi_dung: {
        ...
        'noi_dung.lua_chons': {
            ...
            'noi_dung.lua_chon.$.tieu_de': {
                type: String
            },
            'noi_dung.lua_chon.$.isCorrect': {
                type: Boolean
            },
            'noi_dung.lua_chon.$.order': {
                type: Number
            },
...
Schemas.UserSettingSchema = new SimpleSchema({
    ...
    phan_loai: {
        type: String,
        allowedValues: ['uigrid_state', 'thietbis_template', 'kendo_grid', 'thietbis_grid_config_data_skynet', 'thongsokythuats_grid_config_data_skynet'],
        label: "Phân Loại"
    },
    user: {
        type: Object
