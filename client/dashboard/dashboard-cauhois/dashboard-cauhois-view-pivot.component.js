angular.module('angular-skynet').directive('dashboardCauhoisViewList', function() {
    return {
        restrict: 'E',
        templateUrl: 'client/dashboard/dashboard-cauhois/dashboard-cauhois-view-list.template.html',
        controllerAs: 'vm',
