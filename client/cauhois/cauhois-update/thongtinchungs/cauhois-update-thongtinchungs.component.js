angular.module('angular-skynet').directive('cauhoisUpdateMain', function() {
    return {
        restrict: 'E',
        templateUrl: 'client/cauhois/cauhois-update/thongtinchungs/cauhois-update-thongtinchungs.template.html',
        controllerAs: 'vm',
        scope: {
            source: '=',
            master: '='
